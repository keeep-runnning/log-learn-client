...
const keywords = [
  {
    keyword: "Simple",
    backgroundGradient:
      "linear-gradient(90deg, rgba(254,183,0,1) 10%, rgba(219,235,14,1) 90%)",
  },
  {
    keyword: "Blog Service",
    backgroundGradient:
      "linear-gradient(90deg, rgba(0,254,132,1) 10%, rgba(14,70,235,1) 90%)",
  },
  {
    keyword: "For Everyone",
    backgroundGradient:
      "linear-gradient(90deg, rgba(55,0,254,1) 10%, rgba(233,14,235,1) 90%)",
  },
];
